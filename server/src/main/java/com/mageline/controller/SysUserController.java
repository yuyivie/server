...
import com.mageline.constant.Root;
import com.mageline.entity.SysUser;
import com.mageline.entity.SysUserRole;
import com.mageline.service.SysRoleService;
import com.mageline.service.SysUserRoleService;
import com.mageline.service.SysUserService;
import com.mageline.util.PageUtils;
...
public class SysUserController {
    ...
    private static final Logger log  = LogManager.getLogger("BUSSINESS_ROLLING_FILE");;
    ...
    public Json query(@RequestBody String body) {
        ...
        log.info("{}, body33: {}",oper,body);
        log.info("测试info");
        log.error("测试error");
        log.debug("测试debug =====");
        System.out.println("asdasddsfasfd===========");
        JSONObject json = JSON.parseObject(body);
